                    ...
                    >
                        ...
                        <tr>
                            ...
                            <h3 style="
                                ...
                                font-family: sans-serif;
                                float: left;
                            ">Hello {{ $booking->name }},</h3><br/>
                            @if($booking->event_id != null)
                                Thank you for booking "{{ $booking->event->title }}" with us. Please find the booking
                                detail below.
                            @elseif ($booking->service_id != null)
                                Thank you for booking "{{ $booking->service->title }}" with us. Please find the booking
                                detail below.
                            @endif
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            >
                                ...
                                >
                                    <!-- LIST ITEM -->
                                    @if($booking->event)
                                        <x-book-list title="Event Name:" :value="$booking->event->title"/>
                                        <x-book-list title="Event Date:" value="{{ date('M d, Y', strtotime($booking->event->start_date)) }} to {{ date('M d, Y', strtotime($booking->event->end_date)) }}"/>
                                        <x-book-list title="Event Location:" :value="$booking->event->location"/>
                                        <x-book-list title="Event Description:" :value="$booking->event->description"/>
                                        <x-book-list title="Event Category:" :value="$booking->event->category->name"/>
                                        <x-book-list title="Event Organiser:" :value="$booking->event->o_name"/>
