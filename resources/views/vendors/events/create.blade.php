...
@section('page')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('vendor.events') }}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('vendor.events.save') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
